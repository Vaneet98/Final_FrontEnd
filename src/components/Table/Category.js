  ...
  const colunms = [
      ...
      },
    {
      ...
      cell: (row) => (
        ...
        >
          <button onClick={()=>navigate(`/edit/${row.salaryId} `)} style={{ border: "none",backgroundColor:"white" }}>
            {" "}
            <i className="fa-solid fa-pen fa-lg"style={{color:"blue",backgroundColor:"white"}}></i>
          </button> 
          <button onClick={ ()=>block(row.salaryId)} style={{ border: "none",backgroundColor:"white" }}>
