  ...
  const colunms = [ 
      ...
      },
    {
      ...
      cell: (row) => (
        ...
        >
          <button onClick={()=>navigate(`/editEducation/${row.eduId} `)}  style={{ border: "none",backgroundColor:"white" }}>
            {" "}
            <i className="fa-solid fa-pen fa-lg"style={{color:"blue",backgroundColor:"white"}}></i>
          </button>
          <button onClick={ ()=>block(row.eduId)} style={{ border: "none",backgroundColor:"white" }}>
